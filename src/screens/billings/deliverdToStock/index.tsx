...
const DeliveredToStockBillingsScreen = () => {
  ...
  const { stockedBillings } = useFilterBillings(data);

  return (
    <ScrollView className="mb-14 mt-5">
      <View className="w-full flex-col mx-auto">
        {stockedBillings && stockedBillings.length > 0 ? (
          stockedBillings.map((bil) => {
...
export default DeliveredToStockBillingsScreen;
