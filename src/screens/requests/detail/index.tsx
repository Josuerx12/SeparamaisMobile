          ...
          <View className="flex-row gap-2 flex-wrap">
            ...
            <View className="basis-32 flex-grow items-center">
              ...
              <TextInput
                ...
                placeholderTextColor={"#000"}
                editable={false}
                defaultValue={new Date(request.separetedAt).toLocaleDateString(
                  "pt-BR"
                )}
              />
            </View>
            ...
            <View className="basis-32 flex-grow items-center">
              ...
              <TextInput
                ...
                placeholderTextColor={"#000"}
                editable={false}
                defaultValue={new Date(request.separetedAt).toLocaleTimeString(
                  "pt-BR"
                )}
              />
            </View>
          ...
          <View className="flex-row gap-2 flex-wrap">
            ...
            <View className="basis-32 flex-grow items-center">
              ...
              <TextInput
                ...
                placeholderTextColor={"#000"}
                editable={false}
                defaultValue={new Date(request.collectedAt).toLocaleDateString(
                  "pt-BR"
                )}
              />
            </View>
            ...
            <View className="basis-32 flex-grow items-center">
              ...
              <TextInput
                ...
                placeholderTextColor={"#000"}
                editable={false}
                defaultValue={new Date(request.collectedAt).toLocaleTimeString(
                  "pt-BR"
                )}
              />
            </View>
